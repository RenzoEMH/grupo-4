  ...
  return (
    <div className="simple container text-center d-flex flex-column gap-5">
      ...
      <section className="simple__main d-grid col-10 col-lg-5 mx-auto">
        <h2 className="simple__subtitle mb-5">Cambio de contraseña exitoso</h2>
        <div className="mb-4">
          <p className="password-recovery__text">
            Se ha reestablecido su contraseña de manera exitosa. Ingrese a su
            cuenta para comenzar a crear eventos.
          </p>
        </div>
